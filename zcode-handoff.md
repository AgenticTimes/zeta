...
## 四、当前状态（2026-09-26，批次 513 收口）

- **主线**：qwen 在批次 449（元组槽位类型标记——正是我移交的族），`3e009acd` 之后持续合并中（493–496、503–506 已并入）。
- **cleanup 领先主线**：~12 提交（497–501、512、513 等）。
- **差分一致率**：88–90%（缺口率稳态 12%，无新族时不动）。
- **门禁基线**：python_style 365 过/2 红（t231/t233 存量）/15 known-fail；official 194/194；语料 40/40；jit 180/0。
